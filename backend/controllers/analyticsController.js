...
exports.getAnalytics = asyncHandler(async (req, res) => {
  ...
  const analytics = {
    ...
    totalRevenue: round2(ctx.totalRevenue),
    totalCost: round2(ctx.totalCost),
    profitMargin: safeNumber(ctx.profitMargin),
    todayProfit: round2(ctx.todayProfit),
    weeklyProfit: round2(ctx.weeklyProfit),
    monthlyProfit: round2(ctx.monthlyProfit),
    highestProfitProduct: ctx.highestProfitProduct,
    topProfitableProduct: ctx.topProfitableProduct,
    highestProfitInvoice: ctx.highestProfitInvoice,
    hasHistoricalInvoices: Boolean(ctx.hasHistoricalInvoices),
