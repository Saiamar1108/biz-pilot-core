...
export function WelcomeModal({
  ...
  return (
    <Dialog open={open} onOpenChange={(next) => { if (!next) onGotIt(); }}>
      <DialogContent className="sm:max-w-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-bottom-2 data-[state=open]:slide-in-from-bottom-2 duration-300">
        ...
        <DialogHeader className="pt-8">
          ...
          <DialogDescription className="text-center text-sm leading-relaxed pt-2">
            Your workspace includes sample products, customers, and invoices so you can explore all features immediately.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-3 px-2">
          <div className="flex items-start gap-3 rounded-xl border border-border/60 bg-secondary/30 p-3 text-sm">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Replace sample data with your real inventory and client list.</p>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-xl border border-border/60 bg-secondary/30 p-3 text-sm">
            <div className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-primary/10 text-primary">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">All demo records are fully editable and removable.</p>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-xl border border-border/60 bg-secondary/30 p-3 text-sm">
            <div className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-primary/10 text-primary">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Try billing, inventory, analytics, and AI features risk-free.</p>
            </div>
          </div>
        </div>
